...
export default class ReadStreamParser implements Parser<Array<ReadStream>, Array<Promise<ParseResults>>> {
  ...
  parse(streams: Array<ReadStream>): Array<Promise<ParseResults>> {
    try {
